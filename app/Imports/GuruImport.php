...
{
    /**
     * Define the starting row to skip headers
     *
     * @return int
     */
    ...
    public function model(array $row)
    {
        try {
            ...
            // Fetch the operator based on the currently authenticated user
            ...
            // Rethrow the exception to stop the import process for this row
    ...
    public function rules(): array
    {
        return [
            ...
            '1' => 'required|numeric|unique:guru,nip', // NIP (unique in the 'guru' table)
