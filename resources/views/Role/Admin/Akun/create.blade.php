        ...
        <form action="{{ route('Admin.Akun.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama_sekolah" id="nama_sekolah" 
                    ...
                    value="{{ old('nama_sekolah') }}" placeholder="Masukkan nama sekolah">
                @error('nama_sekolah')
            ...
            <!-- Durasi Field -->
            <div class="mb-6">
                <label for="durasi" class="block text-lg font-medium text-gray-700 mb-2">Durasi<span class="text-red-500">*</span></label>
                <input type="number" name="durasi" id="durasi" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('durasi') border-red-500 @enderror" 
                    placeholder="12" value="{{ old('durasi') }}">
                @error('durasi')
                    <span class="text-sm text-red-500">{{ $message }}</span>
                @enderror
            </div>
